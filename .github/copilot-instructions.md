...
For detailed coding standards, review guidelines, and contribution requirements, refer to [`CLAUDE.md`](../CLAUDE.md) in the project root. This file contains:

- Component size limits (300 lines max)
- Hover state implementation (Tailwind over JS)
- Accessibility requirements (ARIA, keyboard navigation)
- Testing standards (Vitest + RTL)
- Icon system usage
- Styling conventions (Tailwind over inline styles)
- Z-index hierarchy
- Error handling patterns
- TypeScript strict typing rules
- Performance optimization guidelines

When reviewing PRs or suggesting code changes, ensure compliance with these standards.

    ...
    <DocsLayout>
      ...
      <section className="px-4 sm:px-6 py-16 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-(--monarch-text) mb-6">
            Powerful tools that work with your Monarch Money account. Each feature can be enabled
            independently.
          </p>
          ...
          <div className="flex items-center justify-center gap-8 text-sm">
            <div>
              <span className="text-2xl font-bold text-(--monarch-orange)">{counts.available}</span>
              <span className="text-(--monarch-text-muted) ml-2">Available</span>
            </div>
            {counts.comingSoon > 0 && (
              <div>
                <span className="text-2xl font-bold text-(--monarch-warning)">
                  {counts.comingSoon}
                </span>
                <span className="text-(--monarch-text-muted) ml-2">Coming Soon</span>
              </div>
            )}
          </div>
        </div>

...
function IdeaCard({ idea }: { idea: PublicIdea }) {
  ...
  return (
    <div className="p-4 rounded-lg border border-monarch-border bg-monarch-bg-page transition-colors hover:border-monarch-orange/30">
      {/* User info */}
      ...
      <div className="flex items-start gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center min-w-12.5 py-1 rounded-lg transition-colors hover:bg-monarch-orange/10"

...
export function AutoSyncSecurityModal({ isOpen, onClose, onEnable }: AutoSyncSecurityModalProps) {
          ...
          <div className="p-4 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm space-y-2" style={{ color: 'var(--monarch-text-muted)' }}>
                    <p>
                      <strong>What happens when you enable auto-sync:</strong>
                    </p>
                    <ul className="list-disc pl-4 space-y-1">
                      <li>
                        A <strong>second copy</strong> of your Monarch credentials will be saved
                      </li>
                      <li>
                        This copy is encrypted with a <strong>server key</strong>, not your
                        passphrase
                      </li>
            ...
            >
              ...
              <span className="text-sm" style={{ color: 'var(--monarch-text-dark)' }}>
                I understand that enabling automatic sync stores a server-accessible copy of my
                Monarch credentials, and I accept this trade-off for the convenience of background
                syncing.
              </span>
            </label>

/**
 * WishlistRow - Individual row component for wishlist items
 *
 * Displays a wishlist item with progress, budget input, and actions.
 * Similar structure to RecurringRow but with wishlist-specific behavior.
 */

import { memo, useState, useRef, useEffect, useCallback } from 'react';
import type { WishlistItem, ItemStatus, RecurringItem } from '../../types';
...
import { WishlistActionsDropdown } from './WishlistActionsDropdown';

/**
 * WishlistCardGrid - Grid layout for wishlist cards with drag/drop reordering
 *
 * Displays wishlist items in a responsive grid (1-3 columns).
...
/** Sortable wrapper for WishlistCard */
...
/** Placeholder card matching WishlistCard structure */
...
export const WishlistCardGrid = memo(function WishlistCardGrid({
  items,
  onEdit,
  onAllocate,
  onReorder,

/**
 * WishlistActionsDropdown - Actions menu for wishlist items
 *
 * Provides actions specific to wishlist items:
 * - Edit item details
 * - Open source URL
...
interface WishlistActionsDropdownProps {
...
export function WishlistActionsDropdown({
  item,
  onEdit,
  onArchive,
  onDelete,

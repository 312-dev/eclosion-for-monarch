 ...
 *
 * Single row displaying a pending bookmark with Skip and Create Target actions.
 */
  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-tour={isFirstRow ? 'wishlist-pending-bookmarks' : undefined}
      >
        <button
          type="button"
          onClick={onSkip}
        ...
        <button
          ...
          aria-label={`Create target from ${displayName}`}
        >
          <Plus size={14} />
          Create Target
        </button>

/**
 * CategoryGroupStep - Category group selection for wishlist wizard
 *
 * Allows user to select a default category group for new wishlist items.
 */
  ...
  return (
    <div className="animate-fade-in">
      ...
      <p className="mb-6" style={{ color: 'var(--monarch-text-muted)' }}>
        Select where your wishlist savings categories will be created in Monarch Money.
      </p>
      ...
      {!loading && groups.length > 0 && (
        <div className="mb-4">
          ...
          <SearchableSelect
            ...
            aria-labelledby="wishlist-category-group"
          />
          <p className="mt-2 text-sm" style={{ color: 'var(--monarch-text-muted)' }}>
            Each wishlist item will create a dedicated category in this group.
          </p>
        </div>
      )}

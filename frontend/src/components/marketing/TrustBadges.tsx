  ...
  return (
    <div className={containerClass}>
      ...
      <a
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-medium bg-(--monarch-bg-hover) text-(--monarch-text) hover:bg-(--monarch-bg-page) transition-colors"
      ...
      >
        <span className="text-(--monarch-success)">MIT</span>
        License
        <ExternalLinkIcon size={10} className="text-(--monarch-text-muted)" />
      </a>

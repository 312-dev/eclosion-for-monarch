/**
 * ResetFeatureModal - Modal dialog for resetting a feature
 *
 * Accessibility features:
 * - role="dialog" with aria-modal
 * - aria-labelledby pointing to the title
 * - Focus trap and focus management on open/close
 * - Escape key to close
 * - Proper button types
 */
    ...
    <div className="fixed inset-0 z-(--z-index-modal) flex items-center justify-center" role="presentation">
      ...
      >
        ...
        <div className="p-4 space-y-4">
          ...
          {error && (
            <div className="p-3 rounded-lg" style={{ backgroundColor: 'var(--monarch-error-bg)', color: 'var(--monarch-error)' }} role="alert">
              {error}
            </div>
          )}
